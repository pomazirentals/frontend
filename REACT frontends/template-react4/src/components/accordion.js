...
const Accordion = (props) => {
  return (
    <div className={`accordion-thq-accordion-elm ${props.rootClassName} `}>
      <div
        data-role="accordion-container"
        className="accordion-thq-element-elm1 accordion-element"
      >
        <div className="accordion-thq-details-elm1">
      ...
      <div
        data-role="accordion-container"
        className="accordion-thq-element-elm2 accordion-element"
      >
        <div className="accordion-thq-details-elm2">
      ...
      <div
        data-role="accordion-container"
        className="accordion-thq-element-elm3 accordion-element"
      >
        <div className="accordion-thq-details-elm3">
